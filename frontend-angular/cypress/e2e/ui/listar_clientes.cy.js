describe('template spec', () => {
  it('passes', () => {
    ...
    cy.get('a[href="/facturacion"]').click();
    cy.get('#mat-tab-group-0-content-0 th.mat-column-tipoDocumento').click();
    cy.get('#mat-tab-group-0-content-0 tr:nth-child(1) td.mat-column-tipoDocumento').click();
  })
})